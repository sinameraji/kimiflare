...
## [0.69.0](https://github.com/sinameraji/kimiflare/compare/v0.68.1...v0.69.0) (2026-05-16)
...
* add billing notice to README and terminal welcome screen ([e90c3af](https://github.com/sinameraji/kimiflare/commit/e90c3afd7a131641e6e5084c40616757f8f52ed2))
...
* local structured agent memory — SQLite + embeddings for cross-session context ([9e61ba2](https://github.com/sinameraji/kimiflare/commit/9e61ba29b2906f824c993d4fc7063e6a4d8c1b6f))
