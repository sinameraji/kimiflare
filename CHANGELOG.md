...
## [0.21.0](https://github.com/sinameraji/kimiflare/compare/kimiflare-v0.20.3...kimiflare-v0.21.0) (2026-04-24)


### Features

* /cost command + cost debug logging ([65119f1](https://github.com/sinameraji/kimiflare/commit/65119f12fa658bd79b6f51e72630ddede5e78b10))
...
* add Claude Code-style UX (modes, themes, thinking, resume, compact, queue) ([3c6fae7](https://github.com/sinameraji/kimiflare/commit/3c6fae784fa8bf386da34eba4bd65ec2f495aad3))
...
* agent task panel + Ctrl-O verbose toggle ([101ba58](https://github.com/sinameraji/kimiflare/commit/101ba588de51bb475e3fc1400ae8db43c98b9023))
...
* **agent:** system prompt + agent loop (model ↔ tools) ([9a98faf](https://github.com/sinameraji/kimiflare/commit/9a98faff9dd571198bac931504a0c558c75d7cfd))
...
* Claude Code-style UX (modes, themes, thinking, resume, compact, queue) ([e84ff23](https://github.com/sinameraji/kimiflare/commit/e84ff230593826f288f6c0cb68e60d111ed1fa4b))
...
* **cli:** print mode + config loader (end-to-end works) ([fb4d455](https://github.com/sinameraji/kimiflare/commit/fb4d45515be56b1aae3989f677afd09ef38a956d))
* collapse long pastes to [pasted N lines] in the prompt ([2ee4d64](https://github.com/sinameraji/kimiflare/commit/2ee4d64c21340e31523425cf3779a70ea8c94730))
...
* custom text input with keyboard shortcuts, message queue, history nav, and update checker ([eb0271a](https://github.com/sinameraji/kimiflare/commit/eb0271ae58409bdbda79dd0cb412ba1649e8e0fb))
...
* drop image content from message history after N turns ([4c60339](https://github.com/sinameraji/kimiflare/commit/4c603399126112ad05f593a968165ce75a9a1399)), closes [#98](https://github.com/sinameraji/kimiflare/issues/98)
...
* interactive onboarding, /logout, and npm prepublish script ([a70d015](https://github.com/sinameraji/kimiflare/commit/a70d015a5190698ad106d3d5806ac69c85a8b529))
* macOS-style cursor motion in the prompt ([6fc0b0b](https://github.com/sinameraji/kimiflare/commit/6fc0b0b67711a2777b803e9eab680d97ea56c741))
...
* **tools:** read/write/edit/bash/glob/grep/web_fetch + executor ([578c0b3](https://github.com/sinameraji/kimiflare/commit/578c0b3521e57ce0b18ea07b5d1cf33e0320f544))
* **transport:** SSE reader + Cloudflare Workers AI client ([262a395](https://github.com/sinameraji/kimiflare/commit/262a395c5f1bf49b6e58eada452799e96b58ff9f))
* **tui:** full Ink interactive terminal UI ([ca6c408](https://github.com/sinameraji/kimiflare/commit/ca6c408a0bfa47e401aa97f796cd6ccb9ba6e4b7))
...
* /update checks npm registry; add auto-publish workflow ([52735c0](https://github.com/sinameraji/kimiflare/commit/52735c00e8d7a74310b7164f4ca8df1f8f36d587))
* add repository field for npm provenance ([ed5ec4c](https://github.com/sinameraji/kimiflare/commit/ed5ec4c6613e41fbb97d4a490e3b025d65ec2027))
* add repository/homepage/bugs fields for npm provenance ([2604208](https://github.com/sinameraji/kimiflare/commit/2604208de08378ec122af8fbdeb79a5655a4d7df))
...
* include README.md in published package ([6cdeae9](https://github.com/sinameraji/kimiflare/commit/6cdeae959d7939c463c8b2364bfd90777111fbb2))
